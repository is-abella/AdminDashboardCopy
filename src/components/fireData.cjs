...
var fetchDataFromFirebase = function () { return __awaiter(void 0, void 0, void 0, function () {
    var db, dataRef, snapshot, data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                db = (0, database_1.getDatabase)(firebase_1.default);
                dataRef = (0, database_1.ref)(db, '/');
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
...
exports.default = fetchDataFromFirebase;
