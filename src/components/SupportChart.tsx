...
const SupportChart: React.FC<EngagementProps> = ({ selectedNamesList }) => {
	...
	const processData = (data: Person[], filteredNames: string[]) => {
		...
		data.forEach((item: Person) => {
			...
			const support = item["For Group - My group members are supportive of one another"];
